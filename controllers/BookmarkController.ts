...
export default class BookmarkController implements BookmarkControllerI {
    ...
    public static getInstance = (app: Express): BookmarkController => {
        if(BookmarkController.bookmarkController === null) {
            ...
            app.post("/api/users/:uid/bookmarks/:tid", BookmarkController.bookmarkController.userBookmarkTuit);
            app.delete("/api/users/:uid/unbookmarks/:tid", BookmarkController.bookmarkController.userUnBookmarkTuit);
        }
     ...
     * database
     */
    userBookmarkTuit = (req: Request, res: Response) =>
        BookmarkController.bookmarkDao.userBookmarkTuit(req.params.uid, req.params.tid)
            .then(bookmarks => res.json(bookmarks));

    /**
     * @param {Request} req Represents request from client, including the
     * path parameters uid and tid representing the user that is unbookmarks
